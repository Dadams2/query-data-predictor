...
class TestDataLoader:
    ...
    def test_init(self, sample_dataset_dir):
    ...
    def test_get_results_for_session(self, sample_dataset_dir):
    ...
    def test_get_results_for_query(self, sample_dataset_dir):
    ...
    def test_metadata_column_handling(self, sample_dataset_dir):
    ...
    def test_file_not_found(self, sample_dataset_dir):
