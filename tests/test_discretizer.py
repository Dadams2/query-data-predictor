...
class TestDiscretizer:
    ...
    def test_save_load_params(self, temp_file_path, sample_df):
        ...
        discretizer1.discretize_dataframe(sample_df.copy())
    ...
    def test_discretize_equal_width(self, sample_df):
        ...
        result = discretizer.discretize_dataframe(sample_df.copy())
    ...
    def test_discretize_invalid_method(self, sample_df):
        ...
        with pytest.raises(ValueError, match="Invalid method"):
            discretizer.discretize_dataframe(sample_df.copy())
    ...
    def test_discretize_no_float_columns(self):
        ...
        discretizer = Discretizer()
        result = discretizer.discretize_dataframe(df.copy())
    ...
    def test_discretize_with_existing_params(self, sample_df):
        ...
        result = discretizer.discretize_dataframe(new_df.copy())
