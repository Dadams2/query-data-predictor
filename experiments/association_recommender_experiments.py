...
from query_data_predictor.recommender.association_recommender import AssociationRecommender
...
class RecommenderExperimentRunner:
    ...
    def _initialize_recommenders(self) -> Dict[str, Any]:
        ...
        return {
            ...
            'association': AssociationRecommender(self.recommender_config)
        }
    ...
    def _evaluate_enhanced_recommender(self, 
        ...
        try:
            ...
            timeout_seconds = 120 if len(current_results) < 100 else 240
...
def main():
    ...
    output_dir = f"results/experiment/experiment_results_association_{timestamp}"
